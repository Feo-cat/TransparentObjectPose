...
def _get_backbone_out_indices(
    model: nn.Module,
    backbone_out_layers: Union[List[int], Tuple[int, ...], BackboneLayersSet] = BackboneLayersSet.FOUR_EVEN_INTERVALS,
):
    """
...
class DinoVisionTransformerWrapper(nn.Module):
    ...
    def __init__(
        ...
        backbone_out_layers: Union[str, Tuple[int, ...], BackboneLayersSet],
