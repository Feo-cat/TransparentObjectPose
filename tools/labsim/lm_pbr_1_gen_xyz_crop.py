...
data_dir = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/labsim/train"))
...
scenes = [1]
xyz_root = osp.normpath(osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/labsim/train/xyz_crop"))
