...
def save_images():
    ...
    for i in tqdm(range(args.num_images)):
        ...
        while True: # 【关键修复】加回了 while True，确保每一帧失败后可以重试
            ...
            if whole_obj_visib_ratio < whole_obj_visib_ratio_threshold:
                ...
                continue # 【修复】 失败后，continue 会跳回 while True 的开头进行重试
            else:
                ...
                break # 【修复】 成功后，break 会跳出 while 循环，进入下一个 for i
